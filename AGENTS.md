# AGENTS.md — Guidance for AI Coding Agents (mispitools)
...
## 1) Project context (what this package is)
...
## 3) Local development (agents should follow)
...
## 9) Review-driven improvement backlog (priorities)
